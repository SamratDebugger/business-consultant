...
export default function Hero() {
  return (
    <div className="grid grid-cols-2 items-center  bg-base-200 min-h-screen max-w-1xl pt-10 px-5 ">
      <div className="">
        ...
        <button className="btn btn-ghost btn-lg hover:bg-transparent hover:border-none hover:shadow-none hover:text-success">
